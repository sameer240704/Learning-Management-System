  ...
  return (
    ...
    >
      <div className="flex justify-center align-items gap-10">
        ...
        />
        <img
          src="https://visme.co/blog/wp-content/uploads/2016/04/Header-1200-3.gif"
      ...
      <div>
        ...
        <div>
          {VisualizationTechniques.map(({ name }, index) => (
            <div
              key={index}
              className="chart-selection h-16 w-full mb-2 bg-white flex items-center px-10 rounded text-xl cursor-pointer"
            >
              <input
                type="radio"
                id={`technique-${index}`}
        ...
        <div className="flex items-center justify-center">
          <button
            className="select-button-visual h-14 w-40 bg-white rounded-lg mt-10 mb-4 text-xl transform transition-transform active:scale-95"
